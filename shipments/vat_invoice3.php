...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'issue') {
        if (empty($shipment['customer_tax'])) {
            ...
            if ($invoiceGroup === 'vat8') {
                ...
                $groupLabel   = 'VAT > 0%';
                // Ghi chú HĐ > 0%: không thêm suffix
                // extraNote giữ nguyên như người dùng nhập
            } elseif ($invoiceGroup === 'vat0') {
                $sellsToIssue = $sells_vat_0pct;
                $groupLabel   = 'VAT 0%';
                // Ghi chú HĐ 0%: thêm "| 0" để tránh trùng với HĐ >0%
    ...
    $invoiceGroup  // ← TRUYỀN THÊM THAM SỐ NÀY
);
                    ...
                    if ($client->isSuccess($result)) {
                        ...
                        if (!$stmt2) {
                            ...
                            $stmt2->bind_param("ssssii", $guid, $invNo, $serial, $issuedAt, $userId, $id);
                        } else {
                            $stmt2->bind_param("ssssssii", $guid, $invNo, $serial, $form, $mtc, $issuedAt, $userId, $id);
                        }
...
<div class="container-fluid mt-3 pb-5">
    ...
    <div class="row g-3">
            ...
            <div class="card shadow-sm">
                <div class="card-body p-0">
                    ...
                    <div class="tab-content p-3">
                        ...
                        <!-- ============================================================ -->
                        <!-- TAB PHÁT HÀNH — [CHANGED: split into 2 invoice groups]       -->
                        <!-- ============================================================ -->
                        ...
                        <!-- ============================================================ -->
                        <!-- TAB XEM NHÁP — unchanged from old                            -->
                        <!-- ============================================================ -->
                        ...
                        <!-- ============================================================ -->
                        <!-- TAB THÔNG TIN HĐ — unchanged from old                        -->
                        <!-- ============================================================ -->
        ...
        <!-- RIGHT: SUMMARY CARD — unchanged from old -->
        <div class="col-lg-4">
            ...
            <!-- Thông tin HĐ đã phát hành (nếu có) -->
            <?php if ($hasValidGuid): ?>
            <div class="card shadow-sm border-success">
                <div class="card-header bg-success text-white py-2">
                    <i class="bi bi-check-circle-fill"></i> HĐ đã phát hành
                </div>
                <div class="card-body">
                    <div class="info-row">
                        <div class="info-label">Số HĐ</div>
...
<script>
// Auto-activate correct tab based on PHP $activeTab
