...
<head>
    ...
    <style>
        ...
        /* Arrival Notice table trong view */
    ...
    <div class="container-fluid mt-3 pb-5">
        ...
        <div class="row g-3">
                            ...
                            <table class="table table-bordered table-sell mb-0">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-center">SL</th><th class="text-end">Đơn giá</th>
                                        <th class="text-center">VAT%</th><th class="text-end">Thành tiền</th>
                                        <th class="text-center print-hide" title="Chi hộ"><i class="bi bi-arrow-left-right"></i> Chi hộ</th>
                                        <th>Ghi chú</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="<?php echo $is_pob ? 'row-pob' : ''; ?>">
                                            <td class="text-muted"><?php echo $i++; ?></td>
                                            <td><span class="badge bg-success"><?php echo h($s['code']); ?></span></td>
                                            <td>
                                                <?php if ($is_trucking && !empty($s['notes'])): ?>
                                                    <?php echo h($s['description']); ?>
                ...
                <div class="card shadow-sm mb-3">
                    ...
                    <div class="card-body p-0">
                        <table class="table table-bordered mb-0">
                            <tr><td width="60%" class="fw-bold">Tổng chi phí (COST):</td><td class="text-end text-danger fw-bold"><?php echo number_format($total_cost, 0, ',', '.'); ?> VND</td></tr>
                            <tr><td class="fw-bold">Tổng doanh thu (SELL):</td><td class="text-end text-success fw-bold"><?php echo number_format($total_sell, 0, ',', '.'); ?> VND</td></tr>
                            <?php if ($total_pob > 0): ?>
                            <tr style="background:#fffbeb;"><td class="text-muted small"><i class="bi bi-arrow-left-right text-warning"></i> Trong đó Chi hộ (POB):</td><td class="text-end small" style="color:#92400e;"><?php echo number_format($total_pob, 0, ',', '.'); ?> VND</td></tr>
                            <tr style="background:#dcfce7;"><td class="fw-bold"><i class="bi bi-receipt-cutoff text-success"></i> Tổng xuất HĐ VAT:</td><td class="text-end text-success fw-bold"><?php echo number_format($total_vat_invoice, 0, ',', '.'); ?> VND</td></tr>
                            <?php endif; ?>
            ...
            <div class="col-lg-4">
                ...
                <!-- ARRIVAL NOTICE CHARGES (thay thế Nhà cung cấp) -->
                <div class="card shadow-sm mb-3">
                        ...
                        <?php else: ?>
                            ...
                            <div class="d-flex gap-2 mb-2 flex-wrap">
                                ...
                                <span class="badge bg-warning text-dark">
                                    USD = <?php echo number_format($an_usd_rate, 0, ',', '.'); ?> VND
                                </span>
                                <?php endif; ?>
                                <?php if ($an_eur_rate > 0): ?>
                                <span class="badge bg-info text-dark">
                                    EUR = <?php echo number_format($an_eur_rate, 0, ',', '.'); ?> VND
                                </span>
                                <?php endif; ?>
                            </div>
                            <?php endif; ?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span class="badge bg-secondary"><?php echo h($anr['currency']); ?></span>
                                            </td>
                    ...
                    <div class="card-body p-2">
                        <div class="d-grid gap-2">
                            <a href="arrival_notice.php?id=<?php echo $id; ?>" class="btn btn-info btn-sm">
                                <i class="bi bi-file-earmark-text"></i> Thông Tin Giấy Báo Hàng Đến
                            ...
                            <a href="download_arrival.php?id=<?php echo $id; ?>" class="btn btn-outline-info btn-sm" target="_blank">
                                <i class="bi bi-file-earmark-excel"></i> Xuất Excel Arrival Notice
                            </a>
				<!-- Gửi Arrival Notice qua Email (chuyển xuống đây) -->
			    ...
			    <!-- Gửi Debit Note qua Email (chuyển xuống đây) -->
           		    <a href="send_debit.php?id=<?php echo $id; ?>" class="btn btn-outline-primary btn-sm">
               			<i class="bi bi-envelope-fill"></i> Gửi Debit Note qua Email
                            ...
                            <?php if ($_SESSION['role'] == 'admin'): ?>
                                ...
                                <?php endif; ?>
                                <a href="delete.php?id=<?php echo $id; ?>" class="btn btn-outline-danger btn-sm"
