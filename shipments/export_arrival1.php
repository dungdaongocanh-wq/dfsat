...
$usd_rate = floatval($shipment['arrival_usd_rate'] ?? 25000);
$eur_rate = floatval($shipment['arrival_eur_rate'] ?? 27000);
...
function buildArrivalXlsxContent(array $shipment, array $foreign_charges, array $domestic_charges, float $usd_rate, float $eur_rate): string {
    ...
    foreach(['A'=>1,'B'=>28,'C'=>10,'D'=>14,'E'=>10,'F'=>14,'G'=>16,'H'=>8,'I'=>18,'J'=>12,'K'=>1] as $col=>$w) {
