...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" id="sellForm">
                            ...
                            <div class="mb-3">
                                <div class="pob-check-wrap">
                                    ...
                                    <small class="text-muted d-block mt-1">
                                        ...
                                        Thanh toán qua tài khoản B2B riêng.
                                    </small>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <!-- Hint hiển thị khi mã là TRUCKING -->
    ...
    // -------------------------------------------------------
    // Hiển thị gợi ý khi mã là TRUCKING
    // -------------------------------------------------------
    ...
    document.getElementById('sellForm').addEventListener('submit', function (e) {
        ...
        // Cảnh báo nếu là TRUCKING mà không có ghi chú
