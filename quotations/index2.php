...
// Lấy tổng tiền từng báo giá (SUM amount theo từng tiền tệ)
$sql = "SELECT q.*,
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
					...
					<a href="copy.php?id=<?php echo $row['id']; ?>"
 					  class="btn btn-outline-primary fw-bold" title="Sao chép báo giá"
 					  style="font-size:.8rem; padding:2px 7px;"
