...
class EHoaDonClient
{
    ...
    string $extraNote     = '',
    string $invoiceGroup  = 'all'   // ← THÊM THAM SỐ NÀY
): array {
...
// Thêm hậu tố cho hoá đơn 0% để phân biệt với hoá đơn 8%
if ($invoiceGroup === 'vat0') $note .= ' | 0';
if ($extraNote !== '') $note .= ' | ' . $extraNote;

// PartnerInvoiceStringID phải khác nhau để eHoaDon không báo trùng
$partnerStringId = $shipment['job_no'];
if ($invoiceGroup === 'vat8') $partnerStringId .= '-VAT8';
if ($invoiceGroup === 'vat0') $partnerStringId .= '-VAT0';
